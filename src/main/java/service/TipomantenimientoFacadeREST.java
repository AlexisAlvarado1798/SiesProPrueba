 ...
 */
@Stateless
@Path("siess1.jpa.entidades.tipomantenimiento")
public class TipomantenimientoFacadeREST extends AbstractFacade<Tipomantenimiento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Tipomantenimiento entity) {
        super.edit(entity);
    }
    ...
    public Tipomantenimiento find(@PathParam("id") BigDecimal id) {
