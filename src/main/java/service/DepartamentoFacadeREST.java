 ...
 */
@Stateless
@Path("siess1.jpa.entidades.departamento")
public class DepartamentoFacadeREST extends AbstractFacade<Departamento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Departamento entity) {
        super.edit(entity);
    }
    ...
    public Departamento find(@PathParam("id") BigDecimal id) {
