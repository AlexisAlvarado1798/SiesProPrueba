 ...
 */
@Stateless
@Path("siess1.jpa.entidades.mantenimiento")
public class MantenimientoFacadeREST extends AbstractFacade<Mantenimiento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Mantenimiento entity) {
        super.edit(entity);
    }
    ...
    public Mantenimiento find(@PathParam("id") BigDecimal id) {
