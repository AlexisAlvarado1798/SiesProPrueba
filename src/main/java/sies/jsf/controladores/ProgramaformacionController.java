...
import siess1.ejb.fachadas.ProgramaformacionFacade;
...
public class ProgramaformacionController implements Serializable {
    ...
    @EJB
    private siess1.ejb.fachadas.ProgramaformacionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProgramaformacionCreated"));
    ...
    public Programaformacion obtenerPrograma(String codigo){
        return ejbFacade.obtenerProgramaPorFicha(codigo);
    }
    public List<Programaformacion> obtenerProgramas(String valorBusqueda){
        return ejbFacade.obtenerPrograma(valorBusqueda);
    }

    public String update() {
        try {
            getFacade().edit(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProgramaformacionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProgramaformacionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Programaformacion getProgramaformacion(java.math.BigDecimal id) {
        return ejbFacade.find(id);
    }
    public Programaformacion getProgramaformacion(String codigo) {
        return ejbFacade.getProgramaByCodigo(codigo);
    }
    ...
    public static class ProgramaformacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            String codigo = value.split("-")[1].trim();
            return controller.getProgramaformacion(codigo);
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Programaformacion) {
                ...
                return getStringKey(o.getPkProgramaformacion());
            } else {
