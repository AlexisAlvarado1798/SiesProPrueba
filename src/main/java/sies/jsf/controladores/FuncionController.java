...
import siess1.ejb.fachadas.FuncionFacade;
...
public class FuncionController implements Serializable {
    ...
    @EJB
    private siess1.ejb.fachadas.FuncionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FuncionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FuncionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FuncionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Funcion getFuncion(java.math.BigDecimal id) {
        return ejbFacade.find(id);
    }
    public Funcion getFuncion(String nombre) {
        return ejbFacade.getFuncion(nombre);
    }
    public List<Funcion> getFunciones(String valorBusqueda){
        return ejbFacade.obtenerFuncion(valorBusqueda);
    }
    ...
    public static class FuncionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getFuncion(nombre);
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Funcion) {
                ...
                return getStringKey(o.getPkFuncion());
            } else {
