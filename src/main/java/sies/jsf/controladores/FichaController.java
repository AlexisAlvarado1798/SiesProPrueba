...
import siess1.ejb.fachadas.FichaFacade;
...
public class FichaController implements Serializable {
    ...
    @EJB
    private siess1.ejb.fachadas.FichaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FichaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FichaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("FichaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Ficha getFicha(java.math.BigDecimal id) {
        return ejbFacade.find(id);
    }
    
    public List<Ficha> obtenerFicha (String codigo){
        return ejbFacade.obtenerFichas(codigo);
    }
    ...
    public static class FichaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Ficha) {
                ...
                return getStringKey(o.getPkFicha());
            } else {
