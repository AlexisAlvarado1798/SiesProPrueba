...
import siess1.ejb.fachadas.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private siess1.ejb.fachadas.ProveedorFacade ejbFacade;
    ...
    public String prepareList() {
      ...
      public List<Proveedor> getProveedores (String valorBusqueda){
        return ejbFacade.getProveedores(valorBusqueda);
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProveedorCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProveedorUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ProveedorDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Proveedor getProveedor(java.math.BigDecimal id) {
     ...
     public Proveedor getProveedor(String nit) {
        return ejbFacade.getProveedor(nit);
    }
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ProveedorController controller = (ProveedorController) facesContext.getApplication().getELResolver().
             ...
             String nit = value.split("-")[0].trim();
            return controller.getProveedor(nit);
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Proveedor) {
                ...
                return getStringKey(o.getPkProveedor());
            } else {
