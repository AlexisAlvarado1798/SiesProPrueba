...
public class TipomantenimientoController implements Serializable {
    ...
    private Tipomantenimiento current;
    private DataModel items = null;
    @EJB
    private siess1.ejb.fachadas.TipomantenimientoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Tipomantenimiento) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipomantenimientoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipomantenimientoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipomantenimientoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Tipomantenimiento getTipomantenimiento(java.math.BigDecimal id) {
    ...
    public static class TipomantenimientoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipomantenimiento) {
                ...
                return getStringKey(o.getPkTipomantenimiento());
            } else {
