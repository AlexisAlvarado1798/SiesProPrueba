...
import siess1.ejb.fachadas.EquipoFacade;
...
public class EquipoController implements Serializable {
    ...
    @EJB
    private siess1.ejb.fachadas.EquipoFacade ejbFacade;
    @EJB
    private siess1.ejb.fachadas.FuncionFacade oFuncionFacade;
   ...
   UserTransaction oTransaction;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EquipoCreated"));
            ...
            siess1.jsf.controladores.util.JsfUtil.addErrorMessage(e,
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EquipoUpdated"));
            return "View";
        } catch (Exception e) {
    ...
    public List<Equipo> getEquipos (String valorBusqueda){
        return ejbFacade.getEquipos(valorBusqueda);
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EquipoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Equipo getEquipo(java.math.BigDecimal id) {
        return ejbFacade.find(id);
    }
      public Equipo getEquipo(String placaSena) {
        return ejbFacade.obtenerEquipo(placaSena);
    }
    ...
    public static class EquipoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EquipoController controller = (EquipoController) facesContext.getApplication().getELResolver().
             ...
             String placaSena = value.split("-")[0].trim();
            return controller.getEquipo(placaSena);
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Equipo) {
                ...
                return getStringKey(o.getPkEquipo());
            } else {
